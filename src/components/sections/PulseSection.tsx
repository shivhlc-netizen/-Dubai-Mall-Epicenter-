...
export default function PulseSection() {
  ...
  return (
    <section id="pulse" className="py-20 px-6 lg:px-10 bg-[#080808] overflow-hidden">
          ...
          <div className="w-full md:w-2/3">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="text-gold text-[10px] tracking-[0.3em] uppercase mb-4 font-bold">{latest.category}</div>
