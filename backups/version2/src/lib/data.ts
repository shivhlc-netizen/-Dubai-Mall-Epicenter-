...
export const GALLERY_DATA = [
  {
    ...
    title: 'The Burj Khalifa Outlook',
    description: 'Breathtaking vistas of the worlds tallest tower from our terrace.',
    story: 'Where architectural grandeur meets the sky, offering an unparalleled backdrop for every visitor.',
    media_type: 'image',
    is_featured: true,
  },
  {
    ...
    title: 'Fashion Avenue Majesty',
    description: 'The global epicenter of luxury retail and haute couture.',
    story: 'Home to over 150 luxury brands, representing the pinnacle of global style and sophistication.',
    media_type: 'image',
    is_featured: true,
  },
  {
    ...
    title: 'Aquarium Grandeur',
    description: 'A 10-million liter marine experience suspended in luxury.',
    story: 'A mesmerizing window into the deep, captivating millions with its majestic marine life.',
    media_type: 'image',
    is_featured: true,
  },
  {
    ...
    description: 'A rhythmic cascade of light and art through four levels.',
    story: 'A tribute to the region\'s heritage, blending art and architecture in a constant flow of light.',
    media_type: 'image',
    is_featured: false,
  },
  {
    ...
    title: 'The Fountain Dance',
    description: 'Choreographed water sets with the pulse of the city.',
    story: 'The worlds largest performing fountain, dancing to the rhythm of global and local melodies.',
    media_type: 'image',
    is_featured: false,
  },
];
